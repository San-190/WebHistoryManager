...
public:
	...
	static void buscarPorUrl(Navegador&);
	static void buscarPorTitulo(Navegador& nav);
	static void buscarPorTags(Navegador& nav);
	static void buscarPorBookmarks(Navegador& nav);
	static void filtrarPorUrl(Navegador&);
	static void filtrarPorTitulo(Navegador&);
	static void filtrarPorTags(Navegador&);
